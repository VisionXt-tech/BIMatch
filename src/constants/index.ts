...
export const NOTIFICATION_TYPES = {
  APPLICATION_STATUS_UPDATED: 'APPLICATION_STATUS_UPDATED', // Professional receives this
  NEW_PROJECT_MATCH: 'NEW_PROJECT_MATCH',
  PROFILE_VIEW: 'PROFILE_VIEW',
  NEW_APPLICATION_RECEIVED: 'NEW_APPLICATION_RECEIVED', // Company receives this
  GENERIC_INFO: 'GENERIC_INFO',
  INTERVIEW_PROPOSED: 'INTERVIEW_PROPOSED', // Professional receives this from company
  INTERVIEW_ACCEPTED_BY_PRO: 'INTERVIEW_ACCEPTED_BY_PRO', // Company receives this from professional
  INTERVIEW_REJECTED_BY_PRO: 'INTERVIEW_REJECTED_BY_PRO', // Company receives this from professional
  INTERVIEW_RESCHEDULED_BY_PRO: 'INTERVIEW_RESCHEDULED_BY_PRO', // Company receives this from professional
};
